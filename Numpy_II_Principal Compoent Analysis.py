# -*- coding: utf-8 -*-
"""Copia de Solución_Proyecto_Final_Numpy2_PCA.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1QN2EKt5Tzt09kI5zL9WA5qck0oyms-qU
...
def generar_token(datos):
    pca_resultado = PCA().analisis_comp_princ(datos)
    transformacion_pca = PCA().analisis_comp_princ(datos)

    resultado_str = np.array2string(pca_resultado) + np.array2string(transformacion_pca)

    hash_obj = hashlib.sha256(resultado_str.encode())
